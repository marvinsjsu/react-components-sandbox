...
const PasswordInput = (props) => {
  const { passwordMismatchStyle = {}, userEmail } = props;

  let emailInput = false;
  if (props.hasToken && userEmail && userEmail.length > 0) {
    emailInput = (
      <UserEmail {...props} />
    );
  }
    ...
    <div style={styles.authInstructions}>
      ...
      >
        ...
        <PasswordStrengthDisplay
          password={props.password}
          passwordMismatch={props.passwordMismatch}
        />
        <div
          style={{
            ...styles.bottomLine
        ...
        >
          ...
          <input
            ...
            disabled={props.passwordMismatch || !props.passwordValid}
            value='Next'
          />
        </div>
      </form>
