...
export default class Register extends Component {
      ...
      Api.register(this.state)
        .then(response => {
          ...
          if (response && response.data && !response.data.errors) {
            ...
            Cookie.saveTOTP(response.data.totp);
  ...
  render () {
    const { error, errorMessage, email, password, password_confirmation, showLoader, redirect, disableNext, passwordMismatch, usedEmail, redirectToReferrer } = this.state;
    const { customStyles = {}, displayComponent, siteKey } = this.props;
